...
public class TrashPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                return TrashPageActivity.super.onOptionsItemSelected(item);
            }
        });
        // **************************************

        taskHelper.open();
        listOfTask = taskHelper.getAllTrashTasks();
        taskAdapter = new TaskAdapter(this, listOfTask);
        Log.d("Trash:", "listOfTask: " + listOfTask.size());
                ...
                switch (item.getItemId()) {
                    case R.id.delete_id:
                        for(Task msg : arrayList) {
                            ...
                            taskHelper.open();
                            taskHelper.deleteTrashByRow(id);
                            taskHelper.close();
